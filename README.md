...
- :penguin: [Linux x64 zip  ](https://github.com/Light-Wizzard/QtAppVeyor/releases/download/continuous/QtAppVeyor-Ubuntu-Release-x64.zip)
- :office:  [Windows x64 zip](https://github.com/Light-Wizzard/QtAppVeyor/releases/download/continuous/QtAppVeyor-Windows-Release-x64.zip)
- :apple:   [Apple x64 zip  ](https://github.com/Light-Wizzard/QtAppVeyor/releases/download/continuous/QtAppVeyor-MacOs-Release-x64.zip)
