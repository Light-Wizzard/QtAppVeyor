...
cmd /c cmake .. -G "Ninja" -DBUILD_SHARED_LIBS=OFF "-DCMAKE_TOOLCHAIN_FILE=%APPVEYOR_BUILD_FOLDER%\windows\clang-cl-toolchain.cmake" "-DCMAKE_LINKER=%LLD_LINK%" -DCMAKE_INSTALL_PREFIX=AppDir
If ($?) {
