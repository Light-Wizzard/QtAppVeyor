...
$env:CC=C:\Qt\$env:MY_QT_VERSION\$env:MY_QT_MINGW64\bin\mingw32-gcc.exe
$env:CXX=C:\Qt\$env:MY_QT_VERSION\$env:MY_QT_MINGW64\bin\mingw32-g++.exe
...
cmd /c cmake -G "MinGW Makefiles" -DCMAKE_INSTALL_PREFIX=AppDir ..
If ($?) {
